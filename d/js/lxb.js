...
lxb.add("util", function (e) {
	...
	e.isStandard      = function () {return c.styleType == 1};
	e.isCustom        = function () {return c.styleType == 2};
	...
	e.isLeft          = function () {return c.position > 0};
	e.isRight         = function () {return c.position < 0};
	e.displayGroup    = function () {return c.ifGroup && (c.windowLayout == 2)};
	e.display400      = function () {return c.float_window == 1 || c.float_window == 3};
	e.displayCallback = function () {return c.float_window == 2 || c.float_window == 3};
	e.displayLink     = function () {return c.inviteInfo.linkStatus == 1};
	e.isVisible       = function (m) {return m.style.visibility == "visible"};
	e.isPin           = function () {return c.scode == 1};
	e.position        = function () {
	...
	e.checkFloat = function () {
		...
		if (!!p && !!o) {
			...
			q.create("img", {src: lxb.use("config").Root + "/count.gif?t=o&s=" + m})
		}
	};
	e.loadBPA    = function () {
		var p    = lxb.use("base");
		var n    = p.create("script", {type: "text/javascript", charset: "utf-8"});
		var m    = 0;
...
lxb.add("base", function (d) {
	...
	d.ie  = c;
	d.g   = function (e) {return document.getElementById(e)};
	var m = {};
	if (c < 8) {
		m["class"]  = "className";
	...
	d.encodeHTML  = function (e) {return e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#39;")};
	var g         = new RegExp("(^[\\s\\t\\xa0\\u3000]+)|([\\u3000\\xa0\\s\\t]+\x24)", "g");
	d.trim        = function (e) {return e.replace(g, "")};
	d.filter      = function (e) {
		e = e.replace(/\s+/, "");
	...
	d.ready     = function (e) {k ? e() : p.push(e)};
...
lxb.add("config", function (a) {
	var c = lxb.use("base");
	var e = {
		BDCBID      : '31c37ceb-0185-4476-a71b-49a1ccc38f12', LXBVT: 0, TEMPSITEID: '7773323',
		TEMPPORT    : 'lxbjs.baidu.com/', TEMPFILEROOT: 'float'
	};
	var b = {
		BDCBID: "bdcbid", LXBVT: 1, TEMPSITEID: "siteid", TEMPPORT: "localhost:7779/", TEMPFILEROOT: "float"
	};
	c.extend(b, e);
	...
	a.Lang      = {
		...
		CB_SUCCESS_TIP_TXT_2   : "\u8bf7\u51c6\u5907\u63a5\u542c", CB_INFO_TIP_CLOSE: "\u2573",
		CB_PIN_INTRO           : "\u8bf7\u8f93\u5165\u9a8c\u8bc1\u7801", CB_PIN_OK: "\u786e\u5b9a",
		CB_PIN_CANCLE          : "\u53d6\u6d88", CB_PIN_NULL: "\u9a8c\u8bc1\u7801\u4e0d\u80fd\u4e3a\u7a7a",
		CB_PIN_WRONG           : "\u9a8c\u8bc1\u7801\u9519\u8bef", REFRESH: "\u5237\u65b0", CB_PIN: "\u9a8c\u8bc1\u7801"
	};
	a.ClassName = {
		MAIN               : "lxb-container", TL_PHONE: "lxb-tl-phone", TL_PHONE_EM: "lxb-tl-phone-em",
		CB_ICON            : "lxb-cb-icon", CB_INPUT: "lxb-cb-input", CB_INPUT_BTN: "lxb-cb-input-btn",
		CB_INPUT_TIP       : "lxb-cb-input-tip", CB_INPUT_TIP_CURSOR: "lxb-cb-input-tip-cursor",
		CB_SUCCESS_TIP     : "lxb-cb-success-tip", CB_LOADING_TIP: "lxb-cb-loading-tip", CB_INFO_TIP: "lxb-cb-info-tip",
		INVITE_LINK_CON    : "lxb-invite-link-con", INVITE_LINK_TEXT: "lxb-invite-link-txt",
		INVITE_LINK_BTN    : "lxb-invite-link-btn", Position: {
			HOR: ["lxb-pos-left", "lxb-pos-right"], VER: ["lxb-pos-top", "lxb-pos-middle", "lxb-pos-bottom"]
		}, PositionFix     : {HOR: ["-left", "-right"], VER: ["-top", "-middle", "-bottom"]}
	};
	a.ID        = {
		MAIN          : "LXB_CONTAINER", SHOW: "LXB_CONTAINER_SHOW", IMG_PREV: "LXB_IMG_PREV_",
		COOKIE_DBCLKID: "LXB_DBCLICKID", COOKIE_REFER: "LXB_REFER"
	};
	a.TPL       = {
		...
		CB_SUCCESS_TIP_1    : '<ins class="lxb-cb-success-tip-inner">', CB_SUCCESS_TIP_2: "</ins>",
		...
		CB_SUCCESS_TIP_PHONE: '<ins class="lxb-cb-success-tip-phone">', CB_SUCCESS_TIP_PHONE_END: "</ins>",
		...
		CB_ERROR_TIP_S      : '<ins class="lxb-cb-error-tip">', CB_ERROR_TIP_E: "</ins>",
...
lxb.add("tip", function (d) {
	...
	var j      = function () {l = {arrow: null, close: null, con: null, tipEle: null, value: 10}};
	var a      = function () {
		if (document.compatMode == "BackCompat") {
			return {width: document.body.clientWidth, height: document.body.clientHeight}
		} else {
	...
	var i      = function (m) {
		return {
			width: m.offsetWidth, height: m.offsetHeight, top: m.offsetTop, left: m.offsetLeft
		}
	};
	var e      = function (m) {
		return {
	...
	d.hide     = function () {l.tipEle && (l.tipEle.style.display = "none")}
});
...
lxb.add("business.container", function (e) {
	...
	function b() {
		...
		var p = k.btnHide = c.create("ins", {className: h.MAIN + "-btn-hide"});
		q.appendChild(p);
		...
		p.className = x;
		var o       = c.create("ins", {id: i.SHOW});
		o.appendChild(p);
		p.style.display = "none";
		btnBg           = k.btnShowBg = c.create("ins", {className: h.MAIN + "-btn-show-bg"});
		...
		var s = function (A) {
			...
			if (z > 0) {
				r.sendLog({fType: 1, name: "css", t: (new Date()).getTime()});
				A.call(null)
			} else {
				setTimeout(function () {s(A)}, 30)
			}
		};
		...
		s(function () {
			...
			a({main: k.main, btnShow: k.btnShow, height: j});
		...
		c.ready(function () {
			if (c.ie && c.ie <= 6) {
				k.mask = c.create("iframe", {frameBorder: 0, className: h.MAIN + "-mask"});
				q.appendChild(k.mask);
				p.appendChild(k.btnShowMask = c.create("iframe", {frameBorder: 0, className: h.MAIN + "-mask"}))
			}
...
lxb.add("business.tel", function (a) {
	...
	function c() {
		var h = e.create("ins", {className: f.TL_PHONE});
...
lxb.add("business.pin", function (g) {
	...
	function b() {
		var q = n.main = c.create("ins", {className: j.MAIN + "-pin-con"});
	...
	function f() {
		...
		n.btnClose.onclick = n.btnCancle.onclick = function () {i()};
		...
		n.change.onclick = function () {n.pinImg.src = l + new Date().getTime()}
	}
...
lxb.add("business.callback", function (r) {
	...
	function s() {
		...
		var u = k.input = i.create("input", {
			type: "text", name: "phone", className: f.CB_INPUT, maxlength: 12, value: l
		});
		var z = k.cbCon = i.create("ins", {className: "lxb-callback-container"});
		k.cbCon.appendChild(u);
		var w = k.btn = i.create("ins", {className: f.CB_INPUT_BTN});
		...
		if (b.displayGroup()) {
			...
			var y           = k.groupContainer = i.create("ins", {className: "lxb-group-container"});
			k.cbCon.appendChild(y);
			for (var v = 0; v < g.groupDetail.length; v++) {
				var A                   = i.create("ins", {
					groupid: g.groupDetail[v].groupid, title: "\u514D\u8D39\u56DE\u7535", className: "lxb-group-btn"
				});
		...
		var x = k.tip = i.create("ins", {className: f.CB_INPUT_TIP});
		x.style.display = "none";
		x.innerHTML     = d.CB_INPUT_TIP_1;
		if (i.ie && i.ie <= 6) {
			x.appendChild(i.create("iframe", {className: f.MAIN + "-mask", frameBorder: 0}))
		}
		g.main.appendChild(z);
		g.main.appendChild(x);
		if (b.isPin()) {
			k.pin = lxb.use("business.pin");
			k.pin.init({main: g.main})
		}
	}
	...
	function q() {
		var v = k.infoLayer;
		v     = k.infoLayer = i.create("ins", {className: f.CB_INFO_TIP});
		v.innerHTML  = d.CB_INFO_TIP_MAIN;
		var u        = v.getElementsByTagName("ins");
		k.tipCon     = u[0];
		k.tipOpt     = {arrow: u[1], close: u[2], con: g.main, tipEle: v};
	...
	function t(u) {
		...
		e.show();
		if (u.order == "0") {
			g.successTimer = setTimeout(function () {e.hide()}, 5000)
		} else {
			g.successTimer = setTimeout(function () {e.hide()}, 30000)
		}
	}
	...
	function a() {
		...
		if (!u) {
			u = k.loadingLayer = i.create("ins", {className: f.CB_LOADING_TIP});
	...
	function j(y, x) {
		...
		a();
		g.submitTimer = setTimeout(function () {g.submitTimer = null}, 5000);
		var A         = {vtel: y, siteid: g.siteid, bdcbid: u, refer_domain: g.refer, bpaid: b.getBPAId()};
		if (x) {
			A.g = x
		}
		b.bpaLog();
	...
	function p() {lxb.use("base").create("img", {src: lxb.use("config").Root + "/count.gif?t=o"})}
...
lxb.add("business.invite", function (d) {
	...
	var j                   = [];
	var h                   = 0;
	var k                   = function () {this.transList = []};
	k.prototype             = {
		begin                 : function () {this.transList.push("begin")}, add: function (l) {this.transList.push(l)},
		commit                : function () {
			...
			a.addClass(m, l);
			this.add(function () {a.removeClass(m, l)})
		}, addElement         : function (m, l) {
			if (!m || !l) {
				return
			}
			l.appendChild(m);
			this.add(function () {l.removeChild(m)})
			...
			this.add(function () {m.removeChild(n)})
		}, changeText         : function (l, n) {
			var m       = l.innerHTML;
			l.innerHTML = n;
			this.add(function () {l.innerHTML = m})
	...
	d.init                  = function (n) {
		...
		var m = function () {h = (new Date()).valueOf()};
		if (document.addEventListener) {
	...
	d.schedule              = function () {
		...
		j.push({delay: l, callback: function () {d.invite()}});
		j.push({delay: m, callback: function () {d.minimize()}});
		p--;
		for (var o = 0; o < p; o++) {
			j.push({delay: n, callback: function () {d.invite()}});
			j.push({delay: m, callback: function () {d.minimize()}})
		}
		g()
	};
	d.getOptions            = function () {
		var l = {
			"lxb-invite"               : {
				...
				})(), border         : "none", textAlign: "left", width: (function () {
					var m = 0;
					if (e.background == 1) {
						m = e.width
					} else {
				...
				})(), color          : "#000", borderRadius: "3px", mozBorderRadius: "3px", webkitBorderRadius: "3px"
			}, "lxb-tl-phone"          : {
				width          : "auto", fontFamily: (function () {
					switch (e.telFont - 0) {
						case 0:
							return "\u5b8b\u4f53";
						case 1:
				...
				})(), textAlign: "center", position: "static", margin: "10px 10px 0 10px", color: e.telColor,
				lineHeight     : "1.2em", fontSize: e.telSize + "px"
			}, "lxb-tl-phone-em"       : {
				fontFamily : (function () {
					switch (e.telFont - 0) {
						case 0:
				...
				})(), color: e.telColor, lineHeight: "1.2em", fontSize: e.telSize + "px"
			}, "lxb-callback-container": {
				textAlign: "center", paddingBottom: (function () {
					if (f.displayGroup()) {
						if (f.displayLink()) {
							return "30px"
						} else {
				...
				width          : "130px", height: "22px", display: "inline-block", _display: "inline", _zoom: "1",
				color          : "#000", margin: 0, marginRight: "5px", lineHeight: "17px", top: "auto", left: "50%",
				bottom         : "15px", position: "static", verticalAlign: "middle", borderRadius: "0px",
				mozBorderRadius: "0px", webkitBorderRadius: "0px", backgroundColor: "#fff"
			}, "lxb-cb-input-btn"      : {
				display       : (function () {
					if (f.displayGroup()) {
						return "none"
				...
				})(), position: "static", _zoom: "1", verticalAlign: "middle", lineHeight: "22px", height: "22px",
				border        : "none", backgroundImage: "none", color: e.btnFontColor, backgroundColor: e.btnColor,
				margin        : "0", fontSize: "12px", paddingLeft: "5px", paddingRight: "5px", width: "auto",
				borderRadius  : "0px", mozBorderRadius: "0px", webkitBorderRadius: "0px", top: "auto", left: "50%",
				bottom        : "15px", textAlign: "center", fontWeight: "normal"
			}, "lxb-group-btn"         : {
				"float": "left", width: "107px", height: "25px", lineHeight: "25px", margin: "3px",
				color  : e.btnFontColor, backgroundColor: e.btnColor
			}, "lxb-container-btn-hide": {display: "none"}, "lxb-cb-input-tip": {
				right: "auto", left: "0", top: "-100px"
			}
		};
		return l
	};
...
(function () {
	var k = lxb.use("util");
	var i = lxb.use("log");
	i.sendLog({fType: 1, name: "lxb", t: (new Date()).getTime()});
	function j(t) {
		var e = {};
		...
		e.base = {
			position: t.position, groupDetail: t.groupDetail, windowLayout: t.windowLayout, style: t.style, type: s
		};
		if (k.isStandard()) {
			if (k.isVertical()) {
		...
		if (k.isCustom()) {
			e.custom         = {url: t.imagePath, windowLayout: t.windowLayout, position: t.position, type: s};
			e.base.style     = "custom";
			e.base.imagePath = t.imagePath
		}
		if (k.display400()) {
			e.tel = {phone: t.phone, mode: t.mode, format: t.format, ext: t.ext};
			if (k.isCustom()) {
		...
		if (k.displayCallback()) {
			e.callback = {
				callPhone   : t.cbPhone || "", style: t.style, btnFontContent: t.btnFontContent, siteid: t.siteid,
				btnfontColor: t.btnfontColor, btnColor: t.btnColor, styleType: t.styleType,
				windowLayout: t.windowLayout, ifGroup: t.ifGroup, groupDetail: t.groupDetail, code: t.code,
				refer       : q || ""
			}
		}
		if (u !== 0) {
			...
			e.invite     = {
				ifGroup         : t.ifGroup, vertical: t.position, windowLayout: t.windowLayout,
				status          : t.inviteInfo.status || 0, content: t.inviteInfo.content || "",
				font            : t.inviteInfo.font || 0, fontSize: t.inviteInfo.fontSize || 16,
				fontColor       : t.inviteInfo.fontColor || "#000000", background: t.inviteInfo.background || 1,
				...
				btnFontColor    : t.inviteInfo.btnFontColor || "#ffffff", telFont: t.inviteInfo.telFont || 0,
				telSize         : t.inviteInfo.telSize || 18, telColor: t.inviteInfo.telColor || "#000000",
				height          : t.inviteInfo.height || 140, width: t.inviteInfo.width || 230,
				imgHeight       : t.inviteInfo.imgHeight || 140, imgWidth: t.inviteInfo.imgWidth || 230,
				position        : t.inviteInfo.position || 0, linkStatus: t.inviteInfo.linkStatus || 0,
				linkURL         : t.inviteInfo.linkURL, linkTextContent: t.inviteInfo.linkTextContent || "",
				linkTextColor   : t.inviteInfo.linkTextColor || "#000000", linkTextFont: t.inviteInfo.linkTextFont || 0,
				linkBtnContent  : t.inviteInfo.linkBtnContent || "在线交谈",
				linkBtnBgColor  : t.inviteInfo.linkBtnBgColor || "#000000",
				linkBtnFontColor: t.inviteInfo.linkBtnFontColor || "#ffffff", ifStartPage: t.inviteWay.ifStartPage || 0,
				stayTime        : t.inviteWay.stayTime || 0, inviteTimes: t.inviteWay.inviteTimes || 1,
				inviteInterval  : t.inviteWay.inviteInterval || 0, closeTime: t.inviteWay.closeTime || 0,
	...
	function d(y) {
		i.sendLog({fType: 1, name: "_l", t: (new Date()).getTime()});
		var x = lxb.use("net");
		var s = lxb.use("util");
		if (!!y.status) {
			x.log("error", "init");
		...
		if (v.base) {
			...
			lxb.use("business.container").init(v.base, function (z) {
				...
				i.sendLog({fType: 1, name: "finishRender", t: (new Date()).getTime()});
				s.loadBPA(g.bpa)
			})
		}
	}
	...
	var h = {
		siteid: g.SiteId, bdclickid: o || "", bdcbid: r || "", refer_domain: q || "",
